...
<div role="main" class="main">
        ...
        <div class="container">
            <div class="row py-4 text-center text-lg-start">
                <div class="col-lg-8 order-2 order-lg-1 align-self-center p-static">
                    <h1 class="text-color-dark font-weight-semi-bold text-lg-12 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">Contact Us</h1>
                </div>
                <div class="col-lg-4 order-1 order-lg-2 align-self-center">
                    <ul class="breadcrumb d-flex justify-content-center justify-content-lg-end text-4-5">
                        <li><a href="demo-auto-services.html" class="text-color-dark text-color-hover-primary text-transform-none text-decoration-none">Home</a></li>
                        <li class="active text-color-primary text-transform-none">Contact Us</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row pt-5 py-xl-0">
                    <div class="col-lg-6 pb-4">
                        <div data-plugin-float-element data-plugin-options="{'minWindowWidth': 992, 'startPos': 'top', 'speed': 6.0, 'transition': true, 'transitionDuration': 1000}">
                            <div class="card custom-bg-color-1 border-0 custom-border-radius-1">
                                <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div data-plugin-float-element data-plugin-options="{'minWindowWidth': 992, 'startPos': 'bottom', 'speed': 6.0, 'transition': true, 'transitionDuration': 1000}">
                            <div class="card custom-bg-color-1 border-0 custom-border-radius-1">
                                <div class="card-body">
                                    <img class="img-fluid custom-border-radius-1 mb-4" src="assets/img/demos/marketing-1/generic/generic-10.jpg" alt="">

                                    <div class="overflow-hidden">
                                        <h2 class="text-color-dark font-weight-semi-bold line-height-3 text-4-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="250">321 Street Name<br> <span class="text-4">New York, NY</span></h2>
                                    </div>
                                    <div class="overflow-hidden">
    ...
    <section class="section bg-gradient border-0 m-0">
        <div class="container py-5">
            <div class="row">
                <div class="col">
                    <h3 class="text-10 text-light">Send a Message</h3>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <form class="contact-form form-style-4 form-style-4-border-light-2 form-errors-light pe-lg-5" action="php/contact-form.php" method="POST">
                        ...
                        <div class="row mb-2 mx-0">
                            <input type="text" class="form-control text-3-5 text-color-light px-1 py-3" name="name" placeholder="* Full Name" data-msg-required="This field is required." id="name" required="" />
                        </div>
                        <div class="row mx-0 mb-3">
                            <input type="email" class="form-control text-3-5 text-color-light px-1 py-3" name="email" placeholder="* Email Address" data-msg-required="This field is required." id="email" required="" />
                        </div>
                        <div class="row mb-4 mx-0">
                            <textarea name="message" id="message" rows="4" class="form-control form-control text-3-5 text-color-light px-1" placeholder="* Message"></textarea>
                        </div>
                        <input type="submit" class="btn btn-modern btn-effect-4 btn-rounded btn-dark text-transform-none text-3 font-weight-medium mt-2 mb-2" value="Send Message" />
                    </form>
                </div>
            </div>
        </div>
