...
<div role="main" class="main">
    ...
    <div class="custom-bg-color-1">
            ...
            <div class="row py-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="0">
                        <h3 class="custom-font-1 mb-0">Real-world successes showcasing our <strong class="text-secondary">impactful</strong> marketing strategies and <span class="custom-word-highlight-1 d-inline-block p-relative"><span class="p-relative z-index-2">results</span><img width="100%" src="assets/img/demos/marketing-1/svg/generic-3.svg" alt=""></span></h3>
                    </div>
                </div>
            </div>
            <div class="row pb-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
                        <p class="text-4-5 text-dark line-height-6 mb-0">Our case studies highlight the success stories of businesses that partnered with us to achieve their marketing goals. Each case study showcases the challenges we faced, the strategies we implemented, and the tangible results we delivered.</p>
                    </div>
                </div>
            </div>
            <div class="row py-5">
        ...
        <div class="custom-bg-color-1 overflow-hidden pb-5">
