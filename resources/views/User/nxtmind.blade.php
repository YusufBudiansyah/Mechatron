...
<div role="main" class="main">
            ...
            <div class="row py-lg-5 text-center text-lg-start">
                <div class="col-lg-8 order-2 order-lg-1 align-self-center p-static">
                    <div data-plugin-float-element data-plugin-options="{'minWindowWidth': 992, 'startPos': 'bottom', 'speed': 0.4, 'transition': true, 'transitionDuration': 1000}">
                        <h1 class="text-color-dark font-weight-semi-bold text-lg-12 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0"><mark class="bg-transparent d-inline-block p-0 mark mark-color mark-color-tertiary">NXT Mind</mark></h1>
                    </div>
                </div>
                <div class="col-lg-4 order-1 order-lg-2 align-self-center">
                    <ul class="breadcrumb d-flex justify-content-center justify-content-lg-end text-4-5">
                        ...
                        <li class="active text-color-primary text-transform-none">NXT Mind</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!-- <section class="parallax section section-text-light section-parallax section-center py-0 my-0"
        ...
        data-image-src="assets/img/demos/marketing-1/generic/generic-7.jpg">
        <div class="d-flex justify-content-center">
            <div class="scrollable-parallax-wrapper py-5 pb-5"> Padding bottom ditambahkan
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 p-0">
                <section class="parallax section section-parallax h-100 m-0 pb-5"
                    data-plugin-parallax
                    data-plugin-options="{'speed': 1.5, 'horizontalPosition': '100%'}"
                    data-image-src="assets/img/parallax/parallax-2.jpg"
                    style="min-height: 315px; margin-right: 15px;"></section> <!-- Jarak parallax kanan --> <!-- Padding bottom ditambahkan -->
            </div>
            <div class="col-lg-6 p-0">
                <div class="h-100 m-0">
                    <div class="row m-0">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 p-0">
                <section class="parallax section section-parallax custom-parallax-bg-pos-left custom-sec-left h-100 m-0 pb-5"
                    data-plugin-parallax
                    data-plugin-options="{'speed': 1.5, 'horizontalPosition': '100%'}"
                    data-image-src="assets/img/parallax/parallax-3.jpg"
                    style="min-height: 315px; margin-left: 15px;"></section> <!-- Jarak parallax kiri --> <!-- Padding bottom ditambahkan -->
            </div>
        </div>
    </div>
